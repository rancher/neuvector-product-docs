...
* For configuration backup/HA, a RWX PVC of 1Gi or more. See link:/deploying/production#backups-and-persistent-data[Backups and Persistent Data section] for more details.
...
For additional advice on performance and sizing, see the link:/deploying/production?target=_blank#best-practices-tips-qa-for-deploying-and-managing-neuvector[Onboarding/Best Practices section].
