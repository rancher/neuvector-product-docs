= General Guidelines
:description: Prepare your host environment for SUSE® Security deployment by ensuring containers can communicate, labeling nodes, opening required ports
:revdate: 2024-09-27
...
[#_testing_product_using_the_allinone_container]
...
[#_general_guidelines_for_deployment]
