= 5.x Overview
:description: Learn about the 5.x Overview features and components, including vulnerability scanning, runtime protection, and deployment options for the Full Life-Cycle
:revdate: 2025-01-10
:page-revdate: {revdate}
:page-opendocs-origin: /01.basics/01.overview/01.overview.adoc
:page-opendocs-slug: /basics/overview

[#_the_full_life_cycle_container_security_platform]
...
[#_security_containers]
== Security Containers

The {product-name} run-time container security solution contains four types of security containers: **Controllers**, **Enforcers**, **Managers**, and **Scanners**.
{product-name} can be deployed on virtual machines or on bare metal systems with a single os.

[NOTE]
====
Docker support is deprecated from v5.5.0.
====
...
For common deployment patterns and best practices see the xref:production.adoc#_best_practices_tips_qa_for_deploying_and_managing_product[Onboarding/Best Practices section].

[#_controller_manager_and_enforcer_containers]
