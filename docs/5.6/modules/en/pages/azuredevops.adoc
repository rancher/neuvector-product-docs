= Azure DevOps
:description: Scan vulnerabilities in Azure DevOps build pipelines using the SUSE® Security scanner to check container images and set thresholds for failing builds
:revdate: 2025-05-08
...
[#_scan_for_vulnerabilities_in_the_azure_devops_build_pipeline]
