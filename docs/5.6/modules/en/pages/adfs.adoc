= SAML (ADFS)
:description: Configure ADFS and SUSE Security SAML integration by following steps for relying party trust and claim rules to enable single sign-on
:revdate: 2025-05-08
:page-revdate: {revdate}
:page-opendocs-origin: /08.integration/06.adfs/06.adfs.md
:page-opendocs-slug:  /integration/adfs

[#_setting_up_adfs_and_product_integration]
