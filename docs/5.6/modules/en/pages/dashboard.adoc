...
:description: Use the NeuVector Dashboard in the Rancher portal to switch tabs and view security events, exposure, policy mode, and vulnerable assets
...
[#_functions_not_included_when_comparing_with_the_neuvector_standalone_page]
