= 5.x Release Notes
:description: Check the 5.x release notes to find new features, bug fixes, and compatibility updates for each version, including changes to image scans and error handling
:revdate: 2026-04-27
