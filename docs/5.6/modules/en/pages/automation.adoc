...
:description: Use the REST API to automate security functions in SUSE® Security and manage tasks like scanning, policy enforcement, and event response
:revdate: 2025-05-08
...
For information on Federation automation via ConfigMap view the xref:configmap.adoc#_federated_configmap_examples_fedinitcfgyaml[Federated ConfigMap Examples] documentation.
