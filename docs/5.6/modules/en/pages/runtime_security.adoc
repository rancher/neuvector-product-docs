...
:description: The Assets Security Scan Result page displays runtime vulnerabilities in Rancher Manager nodes and workloads by adding a Vulnerabilities-column
