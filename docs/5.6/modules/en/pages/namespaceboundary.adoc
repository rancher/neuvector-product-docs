...
:description: Apply the NeuvectorNamespaceBoundary label to enforce communication boundaries between pods in different namespaces
:revdate: 2026-02-05
...
[#_policy_namespace_boundary_enforcement]
...
[#_how_namespace_boundary_enforcement_works]
...
[#_enable_or_disable_namespace_boundary_enforcement]
...
[#_behavior_without_namespace_boundary_enforcement]
...
[#_behavior_with_namespace_boundary_enforcement]
