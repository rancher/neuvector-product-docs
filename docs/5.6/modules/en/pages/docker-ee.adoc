...
:description: Deploy Mirantis Kubernetes Engine using Docker Compose to set up clusters, configure containers, and manage workloads using specific environment variables
:revdate: 2024-09-27
...
[IMPORTANT]
====
`Allinone` native Docker support is deprecated from v5.5.0.
====

[#_deploy_to_swarm_cluster]
...
[#_deploy_on_docker_swarm_using_privileged_mode]
