...
[NOTE]
====
. Um alle Bild-Tags zu scannen, fügen Sie den Filter als &#42; oder &#42;:&#42; hinzu. Dies funktioniert bei allen Registry_Typen, außer bei der öffentlichen Docker_Registry.
. Das Repository sollte der vollständige Name sein, wenn die Organisation für die öffentliche Docker_Registry leer ist, oder fügen Sie 'library' vor dem Repository hinzu, wie oben angegeben.
. Erstellen Sie ein virtuelles Repository und fügen Sie alle lokalen Repositories hinzu, um alle Tags in einer JFrog_Registry mit der Subdomain_Docker_Zugriffsmethode zu scannen.
