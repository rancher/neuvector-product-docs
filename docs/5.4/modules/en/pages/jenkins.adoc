...
[#_detailed-configuration-for-the-jenkins-plugin]
...
[#_global-configuration-in-jenkins]
...
[#_local-configuration-for-scanning-a-remote-docker-host]
=== Local Configuration for scanning a remote Docker Host

[#_prerequisites-for-local-scan-on-a-remote-docker-host]
...
[#_setting-up-the-pipeline-to-build-large-scale-parallel-scans]
...
[#_openshift-route-and-registry-token-example]
...
[#_special-use-case-for-jenkins-in-the-same-kubernetes-cluster]
