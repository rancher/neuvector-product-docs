= Jenkins Details
:description: Configure the Jenkins plugin to scan images using Controller and Scanner or standalone scanner mode for vulnerability detection
...
[#_detailed_configuration_for_the_jenkins_plugin]
...
[#_global_configuration_in_jenkins]
...
[#_local_configuration_for_scanning_a_remote_docker_host]
=== Local Configuration for scanning a remote Docker Host

[#_prerequisites_for_local_scan_on_a_remote_docker_host]
...
[#_setting_up_the_pipeline_to_build_large_scale_parallel_scans]
...
[#_openshift_route_and_registry_token_example]
...
[#_special_use_case_for_jenkins_in_the_same_kubernetes_cluster]
