...
[#_policy-namespace-boundary-enforcement]
...
[#_how-namespace-boundary-enforcement-works]
...
[#_enable-or-disable-namespace-boundary-enforcement]
...
[#_behavior-without-namespace-boundary-enforcement]
...
[#_behavior-with-namespace-boundary-enforcement]
