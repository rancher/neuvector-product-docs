...
:description: Configure group metric thresholds to detect high bandwidth or session rate usage in a pod or group for DDoS protection
...
[#_configure_group_metric_thresholds]
...
[#_configure_thresholds_by_using_the_cli]
...
[#_configure_thresholds_by_using_the_web_ui]
