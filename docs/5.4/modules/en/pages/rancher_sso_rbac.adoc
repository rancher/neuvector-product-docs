...
[#_supported-custom-product-role-mapping-in-rancher-sso]
...
[#_resource-display-and-logical-name-mapping]
...
[#_definitions-and-expectations-with-global-cluster-and-project-namespace-roles]
