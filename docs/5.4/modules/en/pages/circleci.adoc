= CircleCI
:description: Use the SUSE® Security CircleCI ORB to scan images in your pipeline by deploying the Allinone or Controller container and configuring environment variables
...
[#_scan_for_vulnerabilities_in_the_circleci_build_pipeline]
...
[#_create_a_context_in_your_circleci_app]
