= Bamboo
:description: Scan for vulnerabilities during Bamboo builds using the SUSE® Security plug-in, download it from the Admin menu, deploy required containers, and configure global settings
