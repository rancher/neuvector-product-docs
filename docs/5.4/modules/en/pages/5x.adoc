...
* Optimized Ingress annotations in the Rancher Helm chart. Updated configurations to ensure backend communication correctly utilizes the HTTPS scheme (e.g., via `traefik.ingress.kubernetes.io/service.serversscheme: https``).
