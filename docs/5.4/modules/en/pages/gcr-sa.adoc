...
:description: Set up a GCP service account to enable GCR scanning in SUSE® Security and trigger repository scans
...
[#_google_gcr_authentication_scanning_with_gcp_service_accounts]
...
[#_obtain_the_access_token_using_the_rest_api]
...
[#_use_the_token_with_product_repository_scanning]
