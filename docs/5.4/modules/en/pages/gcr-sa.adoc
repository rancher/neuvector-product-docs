...
[#_google-gcr-authentication-scanning-with-gcp-service-accounts]
...
[#_obtain-the-access-token-using-the-rest-api]
...
[#_use-the-token-with-product-repository-scanning]
