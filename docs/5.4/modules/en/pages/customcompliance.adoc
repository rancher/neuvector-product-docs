...
:description: Create custom compliance checks to run scripts on containers and hosts, validate conditions, and generate compliance reports
...
[#_creating_custom_scripts_for_compliance_checks]
...
[#_sample_script_to_check_if_container_has_root_account_with_no_password]
...
[#_sample_script_to_check_dirty_cow_file_in_the_container]
...
[#_creating_a_custom_check_script]
...
[#_creating_a_response_rule_for_compliance_report]
