= GitHub
:description: Scan for vulnerabilities in a GitHub Action pipeline using the SUSE® Security Vulnerability Scan Action from the GitHub Action Marketplace to identify vulnerabilities
...
[#_scan_for_vulnerabilities_in_a_github_action_pipeline]
