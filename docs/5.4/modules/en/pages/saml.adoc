= SAML (Okta)
:description: Configure SAML for Okta in SUSE® Security by configuring identity provider attribute mappings and group-based role assignments
