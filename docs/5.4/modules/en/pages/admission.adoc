= Admission Controls
:description: Learn how to use admission controls to manage image and container deployments using SUSE® Security based on user-defined rules
...
[#_controlling_image_container_deployments]
...
[#_enabling_admission_control_webhook_in_product]
...
[#_admission_control_events_notifications]
...
[#_example_with_matching_a_pod_label]
...
[#_example_with_matching_environment_variables_with_secrets]
...
[#_criteria_related_to_scan_results]
...
[#_creating_custom_criteria_rules]
...
[#_federated_scan_results_in_admission_control_rules]
...
[#_configuring_sigstore_cosign_verifiers_for_requiring_image_signing]
...
[#_review_admission_control_configurations]
...
[#_check_the_webhook_configuration]
...
[#_test_the_admission_control_connection_button]
