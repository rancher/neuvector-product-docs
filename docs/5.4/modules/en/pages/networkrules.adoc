= Network Rules
:description: Create, edit, and delete network rules to control allowed and denied application connections using CLI or REST API
...
[#_egress_control_allowing_connections_to_trusted_internal_services_on_other_networks]
...
[#_ingress_ip_policy_based_on_x_forwarded_for]
...
[#_special_enforcement_for_istio_serviceentry_destinations]
...
[#_virtual_host_based_network_policy]
...
[#_split_mode_network_protections]
...
[#_built_in_network_threat_detection]
