...
:description: Configure OpenID Connect for Azure and Okta by entering the issuer URL, client ID, client secret, and redirect URIs, then set permissions and group claim
...
[#_integrating_with_openid_connect_oidc_for_azure_and_okta]
...
[#_microsoft_azure_configuration]
...
[#_product_openid_connect_configuration]
