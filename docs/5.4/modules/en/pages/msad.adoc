= Microsoft AD
:description: Configure SUSE® Security to authenticate with Windows Active Directory by setting user names, Base DN, testing connections, and mapping groups to roles
