...
:description: Enable auto-rotation to update the internal self-signed certificate using Kubernetes Jobs and CronJobs by setting internal.autoRotateCert to true
