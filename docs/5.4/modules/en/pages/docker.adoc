...
[#_kubernetes-deployment-on-mirantis-kubernetes-engine]
...
[#_deploy-product-containers-using-docker-native-or-ucp-swarm]
...
[#_deploy-allinone-for-high-availability]
...
[#_deploy-allinone-using-docker-compose-privileged-mode]
...
[#_add-an-enforcer-container-using-docker-compose-privileged-mode]
...
[#_deploy-the-product-scanner-container]
...
To update the Scanner in order to get the latest CVE database updates from {product-name}, create a cron job to stop and restart the scanner, pulling the latest. See xref:docker.adoc#_docker-native-updates[this section] for details.

[#_deployment-without-using-privileged-mode]
...
[#_deploy-allinone-no-privileged-mode-with-docker-compose]
...
[#_deploy-enforcer-no-privileged-mode-with-docker-compose]
...
[#_deploy-allinone-privileged-mode-with-docker-run]
...
[#_deploy-enforcer-privileged-mode-with-docker-run]
...
[#_deploy-allinone-no-privileged-mode-with-docker-run]
...
[#_deploy-enforcer-no-privileged-mode-with-docker-run]
...
[#_deploy-separate-product-components-on-different-hosts]
...
[#_monitoring-and-restarting-product]
...
[#_deploying-without-privileged-mode]
