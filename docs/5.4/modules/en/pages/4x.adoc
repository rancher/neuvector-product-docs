...
* Rest API xref:automation.adoc#_rest-api[reference doc] is updated to 4.4.1 and 4.4.2.
...
* API's yaml is updated for 4.2 in xref:automation.adoc#_rest-api[Automation section].
...
* Create the xref:scanners.adoc#_manual-deployment-of-multiple-scanners-on-kubernetes[scanner pods]
* Create or update the xref:scanners.adoc#_manual-deployment-of-multiple-scanners-on-kubernetes[scanner cron job]
