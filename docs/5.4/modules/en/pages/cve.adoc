...
[#_openid_connect_is_vulnerable_to_mitm]
...
[#_neuvector_is_shipping_cryptographic_material_into_its_binary]
...
[#_telemetry_sender_is_vulnerable_to_mitm_and_dos]
...
[#_sensitive_information_exposure_in_neuvector_manager_container_logs]
