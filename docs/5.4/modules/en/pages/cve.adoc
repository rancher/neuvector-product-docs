...
[#_openid-connect-is-vulnerable-to-mitm]
...
[#_neuvector-is-shipping-cryptographic-material-into-its-binary]
...
xref:certrotate.adoc#_rotating-sensitive-field-in-configuration[Rotating sensitive field in configuration].
...
[#_telemetry-sender-is-vulnerable-to-mitm-and-dos]
...
[#_sensitive-information-exposure-in-neuvector-manager-container-logs]
