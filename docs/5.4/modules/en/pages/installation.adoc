...
:description: Prepare to deploy SUSE® Security using Kubernetes, OpenShift, Rancher, Docker, or other platforms by following setup steps and configuring volumes and ports,
...
[#_understanding_how_to_deploy_product]
...
See the xref:production.adoc#_best_practices_tips_qa_for_deploying_and_managing_product[Onboarding/Best Practices section] to download an on boarding guide.

[#_deploy_using_kubernetes_openshift_rancher_or_other_kubernetes_based_tools]
...
[#_backing_up_configuration_files]
