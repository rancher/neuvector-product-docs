= Gitlab
:description: Configure a GitLab plugin and use the SUSE® Security REST API to scan vulnerabilities in build pipelines
...
[#_scan_for_vulnerabilities_during_gitlab_build_pipeline]
...
[#_scan_during_gitlab_build_using_rest_api]
