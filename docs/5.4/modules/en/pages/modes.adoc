...
:description: Switch between Discover, Monitor, and Protect modes to learn container behavior, detect network violations, and block unauthorized connections in SUSE®
