= Troubleshooting
:description: Troubleshoot SUSE® Security container deployments by checking configuration steps, logs, and support tools for issues like registry access and controller
...
[#_troubleshooting_product_deployments]
...
[#_login_and_initial_configuration]
...
[#_turning_on_debug_mode_for_product_controllers]
...
[#_kubernetes_openshift_and_other_orchestration_logs]
...
[#_using_the_cli_to_turn_on_debug_mode]
...
[#_using_the_rest_api_to_turn_on_debug_mode]
