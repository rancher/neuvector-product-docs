= Federated Policy
:description: Configure federated policies in the Master cluster to propagate global rules to all clusters as read-only entries
...
[#_export_import_federation_policy]
