...
[#_deploy_separate_product_components_with_redhat_openshift]
...
[#_updating_the_cve_database_on_openshift_deployments]
...
[#_enable_disable_scheduling_on_the_master_node]
...
[#_openshift_deployment_in_non_privileged_mode]
