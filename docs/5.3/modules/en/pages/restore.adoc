...
:description: Apply a configuration backup file manually or via the REST API to restore a previous SUSE® Security configuration when persistent storage is available
:revdate: 2024-12-08
:page-revdate: {revdate}
:page-opendocs-origin: /02.deploying/11.restore/11.restore.md
:page-opendocs-slug: /deploying/restore

[#_restoring_product_configuration]
== Restoring {product-name} Configuration
...
[#_sensitive_data_protected_by_encryption]
...
[#_recommended_high_availability_settings]
