= 4.x Release Notes
:description: Update 4.x images to remediate high-risk vulnerabilities including CVE-2022-28391 and CVE-2022-0778 and include enhancements like Helm chart updates
:revdate: 2025-02-19
:page-revdate: {revdate}
:page-opendocs-origin: /14.releasenotes/03.4x/03.4x.md
:page-opendocs-slug:  /releasenotes/4x

[#_release_notes_for_4x]
