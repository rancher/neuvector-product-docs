...
See the next sections for LDAP, MSAD, SAML, OpenId and other integrations. See the xref:users.adoc#users[Basics -> Users & Roles] section for predefined and custom roles in {product-name} which can be mapped in the integration.
