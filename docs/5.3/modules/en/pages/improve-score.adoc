...
[#_improving-the-security-risk-score]
...
[#_how-to-improve-the-score]
=== How to Improve the Score

[#_product-protection-mode]
...
[#_privileged-and-or-root-containers]
...
[#_how-to-customize-which-container-groups-are-included-in-the-score]
