...
:description: Replace the self-signed certificate with a supported PKCS certificate for external access in Manager and Controller deployments
:revdate: 2024-09-27
...
[#_replacing_the_self_signed_certificate_with_pkcs_certificate_for_external_access]
...
[#_generate_and_use_self_signed_certificate_pkcs8_or_pcks1]
=== Generate and Use Self_signed Certificate PKCS8 or PCKS1
