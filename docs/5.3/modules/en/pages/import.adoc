...
:description: Importing a CRD format file from the console lets you set security policies as regular rules that can be modified or deleted through the console or API
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /05.policy/13.usingcrd/1.import/1.import.md
:page-opendocs-slug:  /policy/usingcrd/import

[#_importing_a_crd_format_file_from_the_console_or_api]
