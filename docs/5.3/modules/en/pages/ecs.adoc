= Amazon ECS
:description: Deploy SUSE Security on Amazon ECS by creating task definitions, setting up security groups, and configuring services
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /02.deploying/09.ecs/09.ecs.md
:page-opendocs-slug: /deploying/ecs

[#_important_deployment_on_amazon_ecs_is_no_longer_supported]
...
[#_sample_ecs_json_task_definitions]
