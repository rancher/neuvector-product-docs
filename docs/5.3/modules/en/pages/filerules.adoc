= File Access Rules
:description: Learn about zero-drift and behavioral learning-based file access protections that monitor and block unauthorized changes to files and directories
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /05.policy/07.filerules/07.filerules.md
:page-opendocs-slug:  /policy/filerules

[#_policy_file_access_rules]
...
[#_behavioral_learning_based_allowed_applications_in_discover_mode]
...
[#_creating_custom_file_directory_monitoring_rules]
...
[#_file_access_rule_order_precedence]
