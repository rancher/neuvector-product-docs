...
[#_policy-groups-process-profile-rules]
...
[#_zero-drift-process-protection]
...
[#_basic-mode-process-protection]
...
[#_behavioral-learning-based-process-protection]
...
[#_process-rules-for-custom-groups]
...
[#_monitor-protect-mode-new-container-started-in-monitor-or-protect-mode]
...
[#_creating-process-profile-rules]
...
[#_built-in-suspicious-process-detection]
...
[#_split-mode-process-file-protections]
== Split Mode Process/File Protections

Container Groups can have Process/File rules in a different mode than Network rules, as described xref:modes.adoc#_network-service-policy-mode[here].
