...
:description: Scan images during the build phase using plugins like Jenkins or REST API, connect to registry or local host, deploy the scanner container, and expose port 10443,
:revdate: 2025-01-10
:page-revdate: {revdate}
:page-opendocs-origin: /06.scanning/03.build/03.build.md
:page-opendocs-slug:  /scanning/build

[#_ci_cd_build_phase_vulnerability_scanning]
...
For Docker-native local scanning, follow the instructions for Docker scanner deployments in the xref:docker.adoc#_deploy_the_product_scanner_container[Docker Production deployments] section for the scanner.

[#_local_build_phase_scanning_scanner_only_no_controller_required]
