...
[#_data-loss-prevention-dlp-and-web-application-firewall-waf]
...
[#_configuring-dlp-and-waf-sensors]
...
[#_configuring-federated-dlp-and-waf-sensors]
...
[#_applying-dlp-waf-sensors-to-container-groups]
...
[#_dlp-waf-actions-in-discover-monitor-protect-modes]
...
[#_testing-the-log4j-waf-detection]
...
[#_managing-waf-rules-using-import-export-or-crds]
