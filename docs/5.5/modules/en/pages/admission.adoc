...
[#_controlling-image-container-deployments]
...
[#_enabling-admission-control-webhook-in-product]
...
[#_admission-control-events-notifications]
...
[#_example-with-matching-a-pod-label]
...
[#_example-with-matching-environment-variables-with-secrets]
...
[#_criteria-related-to-scan-results]
...
[#_creating-custom-criteria-rules]
...
* Image compliance violations. Matches if the image (registry) scan results in any compliance violations. See xref:compliance.adoc#_managing-compliance-and-cis-benchmarks[compliance] for details on compliance checks. 
...
A list of types of secrets detected can be found xref:compliance.adoc#_secrets-auditing[here] 

[#_admission-control-modes]
...
[#_federated-scan-results-in-admission-control-rules]
...
[#_configuring-sigstore-cosign-verifiers-for-requiring-image-signing]
...
[#_review-admission-control-configurations]
...
[#_check-the-webhook-configuration]
...
[#_test-the-admission-control-connection-button]
