...
- Provide an xref:internal.adoc#_replacing-certificates-used-in-internal-communications-of-product[internal certificate using the existing methods].
...
[NOTE]
====
The instructions below apply to upgrades to 5.0.x and 5.1.x. For 5.2.x, service accounts and bindings have changed, and should be xref:kubernetes.adoc#_deploy-product[reviewed] to plan upgrades.
====
