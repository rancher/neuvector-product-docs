...
:description: Configure OpenID Connect (OIDC) for ADFS by creating application groups, setting redirect URIs, and defining claim rules
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /08.integration/08.oidc_adfs/08.oidc_adfs.md
:page-opendocs-slug:  /integration/oidc_adfs

[#_integrating_with_openid_connect_oidc_for_adfs]
