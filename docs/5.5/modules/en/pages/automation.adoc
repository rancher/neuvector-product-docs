...
[#_trigger-vulnerability-scanning-from-a-script]
...
[#_create-policy-rules-automatically]
...
[#_setting-or-changing-user-password]
...
[#_starting-packet-capture-on-a-container]
...
[#_check-and-accept-the-eula-new-deployments]
...
[#_enable-packet-capture-on-all-pods-in-a-namespace]
...
[#_enable-disable-container-quarantine]
...
[#_enable-debugging-mode-for-product-support]
...
[#_report-if-a-vulnerability-is-in-the-base-image-layers]
...
[#_get-the-cve-database-version-and-date]
...
[#_manage-federation-for-master-and-remote-worker-clusters]
...
For information on Federation automation via ConfigMap view the xref:configmap.adoc#_federated-configmap-examples-fedinitcfgyaml[Federated ConfigMap Examples] documentation.
