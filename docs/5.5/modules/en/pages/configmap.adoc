...
The latest ConfigMap can be found at the following https://raw.githubusercontent.com/neuvector/manifests/main/kubernetes/5.5.0/initcfg.yaml[initcfg.yaml].
