= Users and Roles
:description: Configure users and roles, assign custom roles to users, and map groups to roles and namespaces in SUSE® Security
:revdate: 2025-01-10
