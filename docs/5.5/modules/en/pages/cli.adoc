= Command Line
:description: Use the SUSE® Security Command Line to access CLI commands for managing security functions through the Manager, Controller, and Enforcer
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /12.troubleshooting/02.cli/02.cli.md
:page-opendocs-slug:  /tronubleshooting/cli

[#_using_the_product_command_line]
...
[#_command_line_reference_commands]
