...
[#_egress-control-allowing-connections-to-trusted-internal-services-on-other-networks]
...
[#_ingress-ip-policy-based-on-x-forwarded-for]
...
[#_special-enforcement-for-istio-serviceentry-destinations]
...
[#_virtual-host-based-network-policy]
...
[#_split-mode-network-protections]
...
[#_built-in-network-threat-detection]
