...
[#_kubernetes-resource-deployment-file-scanning]
...
[#_managing-vulnerabilities-and-compliance]
...
[#_automated-actions-mitigations-and-responses-based-on-vulnerabilities]
...
[#_federated-registries-for-distributed-image-scanning-results]
