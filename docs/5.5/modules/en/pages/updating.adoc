...
:description: Update SUSE® Security components using Docker and Kubernetes to apply CVE database updates and ensure continuous operation
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /10.updating/01.updating/01.updating.md
:page-opendocs-slug:  /updating/updating

[#_updating_product_components]
...
[#_updating_the_vulnerability_cve_database]
...
[#_upgrading_from_product_4x_to_51x]
...
[#_note_about_scc_and_upgrading_via_operator_helm]
