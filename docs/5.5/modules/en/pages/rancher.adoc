...
[#_deploy-and-manage-product-through-rancher-extensions-or-apps-marketplace]
...
[#_product-ui-extension-for-rancher]
...
[#_mapped-permission-resources-for-global-cluster-role]
...
[#_mapped-permission-resources-for-project-namespace-role]
...
[#_disabling-product-rancher-sso]
