...
[#_integrating-with-openid-connect-oidc-for-azure-and-okta]
...
[#_microsoft-azure-configuration]
...
[#_product-openid-connect-configuration]
...
Please see the xref:users.adoc#_mapping-groups-to-roles-and-namespaces[Users and Roles] section for how to map groups to preset and custom roles as well as namespaces in {product-name}.
