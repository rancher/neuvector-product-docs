= IBM QRadar
:description: Configure the integration between SUSE® Security and IBM QRadar to collect and analyze container security events
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /08.integration/10.ibmqr/10.ibmqr.md
:page-opendocs-slug:  /integration/ibmqr

[#_integrating_with_ibm_qradar]
...
[#_how_to_integrate_product_with_qradar]
...
[#_configure_product_to_send_syslog_to_qradar]
...
[#_configure_qradar_to_analyze_product_logs]
